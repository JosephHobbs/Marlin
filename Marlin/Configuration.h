...
#define CUSTOM_MACHINE_NAME "Ender3v2-SKRMiniE3V3"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 81.01, 81.38, 405.45, 138.39 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -10, -3.3 }
